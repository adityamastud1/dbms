...
<head>
    ...
    <title>Celestial Palace - Admin</title>
</head>
        ...
        <?php       
            if (isset($_POST['guestdetailsubmit'])) {
                ...
                if($Name == "" || $Email == ""){
                    ...
                    $sql = "INSERT INTO roombook(RoomType,Bed,NoofRoom,Meal,cin,cout,nodays) VALUES ('$RoomType','$Bed','$NoofRoom','$Meal','$cin','$cout',datediff('$cout','$cin'))";
