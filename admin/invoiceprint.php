...
<body>
	...
	$sqlo = "select * from payment where id = '$ido' ";
	$reo = mysqli_query($conn, $sqlo);
	while ($rowo = mysqli_fetch_array($reo)) {
		$idi = $rowo['id'];
		$Nameo = $rowo['Name'];
	}
	...
	<aside>
		...
		<div>
			<p align="center">Email: celestialpalace0@gmail.com || Web :- www.celestial.com || Phone :- +91 9313346569 </p>
		</div>
	</aside>
